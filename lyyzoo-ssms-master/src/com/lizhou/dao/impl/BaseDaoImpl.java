...
public class BaseDaoImpl implements BaseDaoInter{
    ...
    public List<Object> getList(Class type, String sql) {
		...
		try {
			list = Collections.singletonList(qr.query(sql, new BeanListHandler(type)));
    ...
    public List<Object> getList(Class type, String sql, Object[] param) {
		...
		List<Object> list = new LinkedList<>();
		try {
			list = Collections.singletonList(qr.query(sql, new BeanListHandler(type), param));
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return list;
    ...
    public List<Object> getList(Connection conn, Class type, String sql) {
		...
		List<Object> list = new LinkedList<>();
		try {
			list = Collections.singletonList(qr.query(conn, sql, new BeanListHandler(type)));
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return list;
    ...
    public List<Object> getList(Connection conn, Class type, String sql, Object[] param) {
		...
		List<Object> list = new LinkedList<>();
		try {
			list = Collections.singletonList(qr.query(conn, sql, new BeanListHandler(type), param));
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return list;
